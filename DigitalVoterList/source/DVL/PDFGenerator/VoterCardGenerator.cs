...
namespace PDFGenerator
{
    ...
    /// Each polling card is appended as a page to a pdf document.
    ...
    class VoterCardGenerator
    {
		...
		/// <summary>
		/// May I have a new polling card generator for this election?
		/// </summary>
		...
		/// <summary>
		/// //Can you save all the polling cards on this location on the harddrive?
		/// </summary>
		...
		private static void FromField(XGraphics gfx, string name, string street, string city){
			...
			string address = name + System.Environment.NewLine + street + System.Environment.NewLine + city;
			tf.DrawString(address, font, XBrushes.Black, new XRect(310, 95, 100, 50));
		}
	   ...
	   /// <param name="city">City of the receiver</param>
		private static void ToField(XGraphics gfx, string name, string street, string city){
			...
			var tf = new XTextFormatter(gfx);
			string address = name + System.Environment.NewLine + street + System.Environment.NewLine + city;
			tf.DrawString(address, font, XBrushes.Black, new XRect(310, 155, 100, 50));
		}

		/// <summary>
		/// Draws static descriptions of the values
		/// </summary>
		/// <param name="gfx">XGraphics object</param>
		...
		private static void PollingVenue(XGraphics gfx, string name, string street, string city){
			...
			var tf = new XTextFormatter(gfx);
			string address = name + System.Environment.NewLine + street + System.Environment.NewLine + city;
			tf.DrawString(address, font, XBrushes.Black, new XRect(45, 95, 100, 50));
		}
		...
		/// <summary>
		/// Draws the graphical lines on the polling card
		/// </summary>
		/// <param name="gfx">XGraphics object</param>
