    ...
    public abstract class DatabaseContract : IDatabase {
        public BallotStatus this[VoterNumber voternumber] {
            ...
            set {
                ...
                Contract.Requires(value != BallotStatus.Received || this[voternumber] == BallotStatus.NotReceived);
                //If it's handed out, you can revoke it.
                Contract.Requires(value != BallotStatus.NotReceived || this[voternumber] == BallotStatus.Received);
