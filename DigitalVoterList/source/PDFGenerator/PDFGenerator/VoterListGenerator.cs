...
namespace PDFGenerator
{
    ...
    public class VoterListGenerator
    {
        ...
        /// </summary>
        /// <param name="rows">The number of rows on each page</param>
        ...
        /// <summary>
        /// Can you save the voter list to this location on the harddrive?
        /// </summary>
        ...
        /// <param name="voterId">The voter id corresponding to the voter</param>
        public void AddVoter(string voterFirstName, string voterLastName, string voterCpr, string voterId)
        {
            ...
            //Add new page if max rows is reached
            if (_count == _rows)
            {
                AddPage();
            }
        ...
        /// <summary>
        /// Creates a new font, where the font size is dependent of the number of rows on each page
        /// </summary>
        ...
        {
            //Release the Xgraphics object for the previous page
            if (_gfx != null)
            {
                _gfx.Dispose();
            }
            ...
            //Set the Xgraphics associated with the current page 
        ...
        /// <summary>
        /// Draws the table lines inside the outer frame
        /// </summary>
        ...
        /// <summary>
        /// Writes the page number on each page in the document
        /// </summary>
